...
/**
 * Typed wrapper around `HttpClient`.
 *
 * Responsibilities:
 ...
 *
 * Cross-cutting concerns (auth header, global loader, error toasts, cache)
 * live in interceptors and are toggled per-request via HttpContext tokens —
 * see `core/http/http-context.tokens.ts`.
 */
...
export class ApiService {
  ...
  /** Peel off `{ data, ... }` envelopes; pass raw `<T>` payloads through untouched. */
